...
async def main():
    ...
    urls = read_urls(f"{current_dir_abspath}/errors.csv")
    ...
    for url in urls:
        try:
            ...
            with open(f"{current_dir_abspath}/errors.csv", "a+", newline="") as errors_file:
                writer = csv.DictWriter(errors_file, fieldnames=["url"])
